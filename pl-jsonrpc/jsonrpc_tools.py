...
from .jsonrpc import call_jsonrpc, make_jsonrpc_error
...
class JsonRpcServer(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        try:
            ...
            methods = self.server.jsonrpc_methods
            result = call_jsonrpc(methods, data_str)
        except ValueError:
            result = make_jsonrpc_error(-32603)
